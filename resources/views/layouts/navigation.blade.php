    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between  items-center h-16">
            ...
            <form action="{{ route('search') }}" method="GET">
                {{--                <x-input-label for="search" :value="__('Введите')"/>--}}

                <x-text-input id="query" type="text" name="query" placeholder="Введите для поиска"/>
                <x-secondary-button type="submit" class="">Найти</x-secondary-button>
            </form>
